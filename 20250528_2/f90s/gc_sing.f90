module constants_gc
  ...
  real(8), parameter :: y02 = 1.0d5
  real(8), parameter :: z02 = 1.0d5
...
program main
  ...
  x0 = (/x01, y01, z01/)
  v0 = (/x02, y02, z02/)
  call Unitmag(x0(1), x0(2), x0(3), b0(1), b0(2), b0(3))    !단위 방향벡터 저장
  vperp = v0-b0*dot_product(b0,v0)
  amu = 0.5d0 * m * (vperp(2)**2+vperp(1)**2+vperp(3)**2) / (q * sqrt(sum(b0**2)))
